...
// Loading and Utility Icons - Removed SpinnerIcon (circular spinner)
...
/** Solid (filled) cart icon for empty state */
export const ShoppingCartIconSolid = ({ size = 24, color = "currentColor", className = "" }) => (
...
export const Icons = {
  ...
  // Spinner: SpinnerIcon, // Removed circular spinner
  Plus: PlusIcon,
  Minus: MinusIcon,
  X: XIcon,
  Eye: EyeIcon,
