...
const ProductReviews = ({ productId }) => {
    ...
    const handleSubmitReview = async (e) => {
        ...
        try {
            ...
            if (response.success) {
                // Always add new review (never update - one review per order per product)
                setReviews(prev => {
                ...
                // Handle error from backend (e.g., review already exists for this order)
                if (response.code === 'REVIEW_ALREADY_EXISTS') {
                    setError('You have already submitted a review for this product in this order. You can add a new review for a different order, but cannot update existing reviews.');
                } else {
    ...
    // Removed handleEditReview - reviews cannot be updated
    // Users can add one review per order per product, but cannot edit existing reviews
                ...
                <div className="header-content">
                    ...
                    {isAuthenticated && (
                        <div className="review-actions">
                            {/* Edit button removed - reviews cannot be updated (one review per order per product) */}
                            {!userReview && (
                                <button
                ...
                <div className="review-form-container">
                    <div className="form-card">
                        <div className="form-header">
                            ...
                            <p>Share your experience with this product (one review per order)</p>
                        </div>
                        ...
                        <div key={review.id} className={`review-item ${isAuthenticated && user && review.userId === user.id ? 'user-review' : ''}`}>
                            <div className="review-header">
                                ...
                                <div className="review-meta">
                                    ...
                                    {/* "Edited" indicator removed - reviews cannot be updated */}
                                    </div>
                                    {/* Edit button removed - reviews cannot be updated (one review per order per product) */}
                                </div>
                            </div>
