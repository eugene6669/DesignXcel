...
export const adminService = {
    ...
    async getBulkOrders(params = {}) {
        try {
            ...
            const response = await apiClient.get(`/api/admin/bulk-orders?${queryParams.toString()}`);
            return response.data;
        } catch (error) {
    ...
    async getBulkOrderDetails(orderId) {
        try {
            const response = await apiClient.get(`/api/admin/bulk-orders/${orderId}`);
            return response.data;
        } catch (error) {
    ...
    async updateBulkOrderStatus(orderId, status, notes) {
        try {
            const response = await apiClient.put(`/api/admin/bulk-orders/${orderId}/status`, { status, notes });
            return response.data;
        } catch (error) {
