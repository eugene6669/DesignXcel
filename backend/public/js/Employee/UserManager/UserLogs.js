// Enhanced UserLogs.js with filtering and detailed display

document.addEventListener('DOMContentLoaded', function() {
    console.log('Enhanced UserLogs.js loaded, fetching activity logs...');
    ...
    async function fetchActivityLogs() {
        try {
            console.log('Making request to /Employee/UserManager/Logs/Data...');
            const response = await fetch('/Employee/UserManager/Logs/Data');
