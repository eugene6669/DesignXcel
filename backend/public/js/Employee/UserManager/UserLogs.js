// Enhanced User ManagerLogs.js with filtering and detailed display

document.addEventListener('DOMContentLoaded', function() {
    console.log('Enhanced User ManagerLogs.js loaded, fetching activity logs...');
    ...
    async function fetchActivityLogs() {
        try {
            ...
            let logsEndpoint = '/Employee/UserManager/Logs/Data'; // Default to Admin
