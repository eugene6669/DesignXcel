// User Manager CMS JavaScript
// Handles content management system functionality for user manager users

document.addEventListener('DOMContentLoaded', function() {
    // Initialize user manager CMS functionality
    initializeUserCMS();
...
function initializeUserCMS() {
    console.log('Initializing User Manager CMS...');
...
function viewContentType(typeId) {
    window.location.href = `/Employee/UserManager/CMS/ContentType/${typeId}`;
}

function createContent(typeId) {
    window.location.href = `/Employee/UserManager/CMS/CreateContent?type=${typeId}`;
}

function editContent(contentId) {
    window.location.href = `/Employee/UserManager/CMS/EditContent/${contentId}`;
}

function previewContent(contentId) {
    window.open(`/Employee/UserManager/CMS/PreviewContent/${contentId}`, '_blank');
}
...
function editPage(pageId) {
    window.location.href = `/Employee/UserManager/CMS/EditPage/${pageId}`;
}

function previewPage(pageId) {
    window.open(`/Employee/UserManager/CMS/PreviewPage/${pageId}`, '_blank');
}
...
function useTemplate(templateId) {
    window.location.href = `/Employee/UserManager/CMS/CreatePage?template=${templateId}`;
}

function previewTemplate(templateId) {
    window.open(`/Employee/UserManager/CMS/PreviewTemplate/${templateId}`, '_blank');
}
...
function editProduct(productId) {
    ...
    window.open(`/Employee/UserManager/Products?edit=${productId}`, '_blank');
}
