...
function viewContentType(typeId) {
    window.location.href = `/Employee/UserManager/UserCMS/ContentType/${typeId}`;
}

function createContent(typeId) {
    window.location.href = `/Employee/UserManager/UserCMS/CreateContent?type=${typeId}`;
}

function editContent(contentId) {
    window.location.href = `/Employee/UserManager/UserCMS/EditContent/${contentId}`;
}

function previewContent(contentId) {
    window.open(`/Employee/UserManager/UserCMS/PreviewContent/${contentId}`, '_blank');
}
...
function editPage(pageId) {
    window.location.href = `/Employee/UserManager/UserCMS/EditPage/${pageId}`;
}

function previewPage(pageId) {
    window.open(`/Employee/UserManager/UserCMS/PreviewPage/${pageId}`, '_blank');
}
...
function useTemplate(templateId) {
    window.location.href = `/Employee/UserManager/UserCMS/CreatePage?template=${templateId}`;
}

function previewTemplate(templateId) {
    window.open(`/Employee/UserManager/UserCMS/PreviewTemplate/${templateId}`, '_blank');
}
...
function editProduct(productId) {
    ...
    window.open(`/Employee/UserManager/ProductInventory?tab=ProductInventory&inventoryProductId=${productId}`, '_blank');
}
