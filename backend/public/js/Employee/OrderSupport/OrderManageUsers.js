// Order Support Users JavaScript
// Handles user management functionality for order manager users

document.addEventListener('DOMContentLoaded', function() {
    // Initialize order manager user management functionality
    initializeOrderManageUsers();
...
function initializeOrderManageUsers() {
    console.log('Initializing Order Support Users...');
...
function editUser(userId) {
    window.location.href = `/Employee/OrderSupport/EditUser/${userId}`;
}

function changeUserRole(userId) {
    window.location.href = `/Employee/OrderSupport/ChangeUserRole/${userId}`;
}
...
function toggleUserStatusById(userId, newStatus) {
    if (confirm(`Are you sure you want to ${newStatus ? 'activate' : 'deactivate'} this user?`)) {
        fetch(`/Employee/OrderSupport/OrderManageUsers/ToggleActive/${userId}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            }
...
function editRole(roleId) {
    window.location.href = `/Employee/OrderSupport/EditRole/${roleId}`;
}
