// Enhanced Order SupportLogs.js with filtering and detailed display

document.addEventListener('DOMContentLoaded', function() {
    console.log('Enhanced Order SupportLogs.js loaded, fetching activity logs...');
    ...
    async function fetchActivityLogs() {
        try {
            ...
            let logsEndpoint = '/Employee/OrderSupport/Logs/Data'; // Default to Admin
