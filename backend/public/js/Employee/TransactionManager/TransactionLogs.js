// Enhanced Transaction ManagerLogs.js with filtering and detailed display

document.addEventListener('DOMContentLoaded', function() {
    console.log('Enhanced Transaction ManagerLogs.js loaded, fetching activity logs...');
    ...
    async function fetchActivityLogs() {
        try {
            ...
            let logsEndpoint = '/Employee/TransactionManager/Logs/Data'; // Default to Admin
