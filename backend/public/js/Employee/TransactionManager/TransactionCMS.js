...
function viewContentType(typeId) {
    window.location.href = `/Employee/TransactionManager/TransactionCMS/ContentType/${typeId}`;
}

function createContent(typeId) {
    window.location.href = `/Employee/TransactionManager/TransactionCMS/CreateContent?type=${typeId}`;
}

function editContent(contentId) {
    window.location.href = `/Employee/TransactionManager/TransactionCMS/EditContent/${contentId}`;
}

function previewContent(contentId) {
    window.open(`/Employee/TransactionManager/TransactionCMS/PreviewContent/${contentId}`, '_blank');
}
...
function editPage(pageId) {
    window.location.href = `/Employee/TransactionManager/TransactionCMS/EditPage/${pageId}`;
}

function previewPage(pageId) {
    window.open(`/Employee/TransactionManager/TransactionCMS/PreviewPage/${pageId}`, '_blank');
}
...
function useTemplate(templateId) {
    window.location.href = `/Employee/TransactionManager/TransactionCMS/CreatePage?template=${templateId}`;
}

function previewTemplate(templateId) {
    window.open(`/Employee/TransactionManager/TransactionCMS/PreviewTemplate/${templateId}`, '_blank');
}
...
function editProduct(productId) {
    ...
    window.open(`/Employee/TransactionManager/ProductInventory?tab=ProductInventory&inventoryProductId=${productId}`, '_blank');
}
