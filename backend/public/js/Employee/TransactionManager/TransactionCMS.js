// Transaction Manager CMS JavaScript
// Handles content management system functionality for transaction manager users

document.addEventListener('DOMContentLoaded', function() {
    // Initialize transaction manager CMS functionality
    initializeTransactionCMS();
...
function initializeTransactionCMS() {
    console.log('Initializing Transaction Manager CMS...');
...
function viewContentType(typeId) {
    window.location.href = `/Employee/TransactionManager/CMS/ContentType/${typeId}`;
}

function createContent(typeId) {
    window.location.href = `/Employee/TransactionManager/CMS/CreateContent?type=${typeId}`;
}

function editContent(contentId) {
    window.location.href = `/Employee/TransactionManager/CMS/EditContent/${contentId}`;
}

function previewContent(contentId) {
    window.open(`/Employee/TransactionManager/CMS/PreviewContent/${contentId}`, '_blank');
}
...
function editPage(pageId) {
    window.location.href = `/Employee/TransactionManager/CMS/EditPage/${pageId}`;
}

function previewPage(pageId) {
    window.open(`/Employee/TransactionManager/CMS/PreviewPage/${pageId}`, '_blank');
}
...
function useTemplate(templateId) {
    window.location.href = `/Employee/TransactionManager/CMS/CreatePage?template=${templateId}`;
}

function previewTemplate(templateId) {
    window.open(`/Employee/TransactionManager/CMS/PreviewTemplate/${templateId}`, '_blank');
}
...
function editProduct(productId) {
    ...
    window.open(`/Employee/TransactionManager/Products?edit=${productId}`, '_blank');
}
