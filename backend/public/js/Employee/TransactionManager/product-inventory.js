...
let currentSelectedProductId = null;
        ...
        function resetPlanProductModalForCreate() {
            ...
            if (form) {
                form.setAttribute('action', '/Employee/TransactionManager/TransactionProducts/Add');
        ...
        if (addPlanProductForm) {
            addPlanProductForm.addEventListener('submit', async function(e) {
                ...
                const actionPath = this.getAttribute('action') || '/Employee/TransactionManager/TransactionProducts/Add';
                ...
                try {
                    ...
                    if (response.ok && result.success) {
                        ...
                        setTimeout(function() {
                            window.location.href = '/Employee/TransactionManager/TransactionProducts';
                        }, 500);
                    } else {
        ...
        function resetRetailProductModalForCreate() {
            ...
            if (form) {
                form.setAttribute('action', '/Employee/TransactionManager/TransactionProducts/RetailAdd');
                form.removeAttribute('data-editing-product-id');
            }
        ...
        if (addRetailProductForm) {
            addRetailProductForm.addEventListener('submit', async function(e) {
                ...
                const actionPath = this.getAttribute('action') || '/Employee/TransactionManager/TransactionProducts/RetailAdd';
        ...
        async function openEditRetailProductModal(inventoryProductId) {
            ...
            try {
                ...
                const form = document.getElementById('addRetailProductForm');
                if (form) {
                    form.setAttribute('action', '/Employee/TransactionManager/TransactionProducts/RetailUpdate/' + inventoryProductId);
        ...
        async function openEditPlannedProductModal(inventoryProductId) {
            ...
            try {
                ...
                const form = document.getElementById('addPlanProductForm');
                if (form) {
                    form.setAttribute('action', '/Employee/TransactionManager/TransactionProducts/Update/' + inventoryProductId);
                    form.setAttribute('data-editing-product-id', String(inventoryProductId));
                }
                const title = addPlanProductModal?.querySelector('h3');
                    ...
                    if (response.ok && result.success) {
                        ...
                        setTimeout(function() {
                            const dest = isProductsListingPage
                                ? '/Employee/TransactionManager/TransactionProducts'
                                : '/Employee/TransactionManager/ProductInventory?tab=ProductInventory';
        ...
        function archiveProduct(productId, productName, isFromProductsTable) {
            showArchiveConfirmModal(productName || 'this product', function () {
                ...
                form.method = 'POST';
                form.action = `/Employee/TransactionManager/ProductInventory/Archive/${productId}`;
