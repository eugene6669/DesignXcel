// Transaction Manager Users JavaScript
// Handles user management functionality for transaction manager users

document.addEventListener('DOMContentLoaded', function() {
    // Initialize transaction manager user management functionality
    initializeTransactionManageUsers();
...
function initializeTransactionManageUsers() {
    console.log('Initializing Transaction Manager Users...');
...
function editUser(userId) {
    window.location.href = `/Employee/TransactionManager/EditUser/${userId}`;
}

function changeUserRole(userId) {
    window.location.href = `/Employee/TransactionManager/ChangeUserRole/${userId}`;
}
...
function toggleUserStatusById(userId, newStatus) {
    if (confirm(`Are you sure you want to ${newStatus ? 'activate' : 'deactivate'} this user?`)) {
        fetch(`/Employee/TransactionManager/TransactionManageUsers/ToggleActive/${userId}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            }
...
function editRole(roleId) {
    window.location.href = `/Employee/TransactionManager/EditRole/${roleId}`;
}
