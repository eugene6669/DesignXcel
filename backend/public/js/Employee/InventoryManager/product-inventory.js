...
let currentSelectedProductId = null;
        ...
        function resetPlanProductModalForCreate() {
            ...
            if (form) {
                form.setAttribute('action', '/Employee/InventoryManager/InventoryProducts/Add');
        ...
        if (addPlanProductForm) {
            addPlanProductForm.addEventListener('submit', async function(e) {
                ...
                const actionPath = this.getAttribute('action') || '/Employee/InventoryManager/InventoryProducts/Add';
        ...
        async function openEditPlannedProductModal(inventoryProductId) {
            ...
            try {
                ...
                const form = document.getElementById('addPlanProductForm');
                if (form) {
                    form.setAttribute('action', '/Employee/InventoryManager/InventoryProducts/Update/' + inventoryProductId);
                    ...
                    if (response.ok && result.success) {
                        ...
                        setTimeout(function() {
                            const dest = isProductsListingPage
                                ? '/Employee/InventoryManager/InventoryProducts'
                                : '/Employee/InventoryManager/ProductInventory?tab=ProductInventory';
        ...
        function archiveProduct(productId, productName, isFromProductsTable) {
            showArchiveConfirmModal(productName || 'this product', function () {
                ...
                form.method = 'POST';
                form.action = `/Employee/InventoryManager/ProductInventory/Archive/${productId}`;
