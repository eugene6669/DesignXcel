// Inventory Manager Users JavaScript
// Handles user management functionality for inventory manager users

document.addEventListener('DOMContentLoaded', function() {
    // Initialize inventory manager user management functionality
    initializeInventoryManageUsers();
...
function initializeInventoryManageUsers() {
    console.log('Initializing Inventory Manager Users...');
...
function editUser(userId) {
    window.location.href = `/Employee/InventoryManager/EditUser/${userId}`;
}

function changeUserRole(userId) {
    window.location.href = `/Employee/InventoryManager/ChangeUserRole/${userId}`;
}
...
function toggleUserStatusById(userId, newStatus) {
    if (confirm(`Are you sure you want to ${newStatus ? 'activate' : 'deactivate'} this user?`)) {
        fetch(`/Employee/InventoryManager/InventoryManageUsers/ToggleActive/${userId}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            }
...
function editRole(roleId) {
    window.location.href = `/Employee/InventoryManager/EditRole/${roleId}`;
}
