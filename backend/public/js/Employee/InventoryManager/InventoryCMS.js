...
function viewContentType(typeId) {
    window.location.href = `/Employee/InventoryManager/InventoryCMS/ContentType/${typeId}`;
}

function createContent(typeId) {
    window.location.href = `/Employee/InventoryManager/InventoryCMS/CreateContent?type=${typeId}`;
}

function editContent(contentId) {
    window.location.href = `/Employee/InventoryManager/InventoryCMS/EditContent/${contentId}`;
}

function previewContent(contentId) {
    window.open(`/Employee/InventoryManager/InventoryCMS/PreviewContent/${contentId}`, '_blank');
}
...
function editPage(pageId) {
    window.location.href = `/Employee/InventoryManager/InventoryCMS/EditPage/${pageId}`;
}

function previewPage(pageId) {
    window.open(`/Employee/InventoryManager/InventoryCMS/PreviewPage/${pageId}`, '_blank');
}
...
function useTemplate(templateId) {
    window.location.href = `/Employee/InventoryManager/InventoryCMS/CreatePage?template=${templateId}`;
}

function previewTemplate(templateId) {
    window.open(`/Employee/InventoryManager/InventoryCMS/PreviewTemplate/${templateId}`, '_blank');
}
...
function editProduct(productId) {
    ...
    window.open(`/Employee/InventoryManager/ProductInventory?tab=ProductInventory&inventoryProductId=${productId}`, '_blank');
}
