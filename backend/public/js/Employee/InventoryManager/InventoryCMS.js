// Inventory Manager CMS JavaScript
// Handles content management system functionality for inventory manager users

document.addEventListener('DOMContentLoaded', function() {
    // Initialize inventory manager CMS functionality
    initializeInventoryCMS();
...
function initializeInventoryCMS() {
    console.log('Initializing Inventory Manager CMS...');
...
function viewContentType(typeId) {
    window.location.href = `/Employee/InventoryManager/CMS/ContentType/${typeId}`;
}

function createContent(typeId) {
    window.location.href = `/Employee/InventoryManager/CMS/CreateContent?type=${typeId}`;
}

function editContent(contentId) {
    window.location.href = `/Employee/InventoryManager/CMS/EditContent/${contentId}`;
}

function previewContent(contentId) {
    window.open(`/Employee/InventoryManager/CMS/PreviewContent/${contentId}`, '_blank');
}
...
function editPage(pageId) {
    window.location.href = `/Employee/InventoryManager/CMS/EditPage/${pageId}`;
}

function previewPage(pageId) {
    window.open(`/Employee/InventoryManager/CMS/PreviewPage/${pageId}`, '_blank');
}
...
function useTemplate(templateId) {
    window.location.href = `/Employee/InventoryManager/CMS/CreatePage?template=${templateId}`;
}

function previewTemplate(templateId) {
    window.open(`/Employee/InventoryManager/CMS/PreviewTemplate/${templateId}`, '_blank');
}
...
function editProduct(productId) {
    ...
    window.open(`/Employee/InventoryManager/Products?edit=${productId}`, '_blank');
}
