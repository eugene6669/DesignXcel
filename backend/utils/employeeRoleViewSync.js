...
function buildUrlReplacements(role) {
    ...
    const pairs = [
        ...
        ['/Employee/Admin/ProductsListing/RetailAdd', `${base}/${p}Products/RetailAdd`],
        ['/Employee/Admin/ProductsListing/RetailUpdate/', `${base}/${p}Products/RetailUpdate/`],
        ['/Employee/Admin/ProductsListing/Add', `${base}/${p}Products/Add`],
        ['/Employee/Admin/ProductsListing/Update/', `${base}/${p}Products/Update/`],
